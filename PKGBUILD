...
package() {
	...
	install -m755 "${srcdir}/forcefully_remove_bootfb.c" "${installDir}/"
	install -m755 "${srcdir}/Makefile" "${installDir}/"
}

# makepkg -g >> PKGBUILD
sha512sums=('226f5334a51e06799b3def6a6904a47d44132d37ae48cc361a34603169cf8e476a20b8350deee12f6f3022a6c88893419ca49290607f72e27ca2c7613ef41661'
